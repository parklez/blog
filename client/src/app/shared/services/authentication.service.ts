...
import { AuthData, RegisterData } from '../models/auth-data';
...
export class AuthenticationService {
  ...
  signUpUser(username: string, password: string,
    firstname: string, game: string, rank: string
  ): Observable<{
    username: string;
    isAuthenticated: boolean;
  }> {
    const bodyData: RegisterData = { username, password, firstname, game, rank };
