...
var PostsService = class _PostsService {
  ...
  fetchPosts(page = 0) {
    if (environment?.static) {
      return this.http.get(`./assets/posts-${page}.json`).pipe(map((response) => {
  ...
  createPost(title, content) {
    return this.http.post("./api/posts", { title, content }).pipe(map((response) => {
  ...
  updatePost(id, post) {
    return this.http.put("./api/posts/" + id, { title: post.title, content: post.content });
  }
  deletePost(id) {
  ...
  getPost(id) {
    ...
    if (environment?.static) {
      ...
      return this.http.get(adress, { responseType: "text" }).pipe(
        map((data) => {
          const content = (0, import_front_matter.default)(data);
          const filename = id.match(/(\d{2,4}-\d{2}-\d{2})-(.*)/);
          const date = filename?.length ? filename[1] : /* @__PURE__ */ new Date();
          return {
            _id: id,
            userId: 0,
...
function PostEditorComponent_form_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngSubmit", function PostEditorComponent_form_0_Template_form_ngSubmit_0_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275element(9, "textarea", 7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 8)(11, "div", 5)(12, "button", 9);
    \u0275\u0275text(13, "Submit");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 5)(15, "button", 10);
    \u0275\u0275listener("click", function PostEditorComponent_form_0_Template_button_click_15_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.cancelFunction.emit());
    });
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div")(18, "button", 11);
    \u0275\u0275listener("click", function PostEditorComponent_form_0_Template_button_click_18_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(19, "Preview");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "div")(21, "a", 12);
    \u0275\u0275text(22, "Markdown reference");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.post._id ? "Update this post" : "Write a new story");
    \u0275\u0275advance(10);
    \u0275\u0275property("disabled", !ctx_r1.postForm.valid);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r1.post._id ? "Cancel" : "Clear");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r1.postForm.valid);
  }
}
function PostEditorComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "app-post", 13)(2, "br");
    \u0275\u0275elementStart(3, "div")(4, "button", 14);
    \u0275\u0275listener("click", function PostEditorComponent_div_1_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.togglePreview());
    });
    \u0275\u0275text(5, "Go back to editor");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var PostEditorComponent = class _PostEditorComponent {
  constructor(postsService, toast) {
    ...
    this.cancelFunction = new EventEmitter();
...
var Marked = class {
  ...
  #parseMarkdown(lexer2, parser2) {
    return (src, options2) => {
      ...
      if (opt.async) {
        return Promise.resolve(opt.hooks ? opt.hooks.preprocess(src) : src).then((src2) => lexer2(src2, opt)).then((tokens) => opt.walkTokens ? Promise.all(this.walkTokens(tokens, opt.walkTokens)).then(() => tokens) : tokens).then((tokens) => parser2(tokens, opt)).then((html) => opt.hooks ? opt.hooks.postprocess(html) : html).catch(throwError2);
      }
      try {
        if (opt.hooks) {
...
function PostComponent_article_0_span_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PostComponent_article_0_span_1_Template_a_click_2_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleEditor());
    });
    \u0275\u0275text(3, "Edit");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, " / ");
    \u0275\u0275elementStart(5, "a", 10);
    \u0275\u0275listener("click", function PostComponent_article_0_span_1_Template_a_click_5_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deletePost());
    });
    \u0275\u0275text(6, "Trash");
    \u0275\u0275elementEnd();
    \u0275\u0275text(7, " ] ");
...
function PostComponent_article_0_span_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, " [ ");
    \u0275\u0275elementStart(2, "a", 10);
    \u0275\u0275listener("click", function PostComponent_article_0_span_2_Template_a_click_2_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.isCollapsed ? "Show more" : "Show less");
  }
}
function PostComponent_article_0_span_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, " [ ");
    \u0275\u0275elementStart(2, "a", 10);
    \u0275\u0275listener("click", function PostComponent_article_0_span_3_Template_a_click_2_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function PostComponent_article_0_a_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PostComponent_article_0_a_4_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.setPreloadedPost());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275propertyInterpolate1("routerLink", "/post/", ctx_r1.post._id, "");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.post.title, " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(7, 4, ctx_r1.post.published), " ");
  }
}
function PostComponent_article_0_a_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a")(1, "strong");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275text(3, " - ");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" ", ctx_r1.post.title, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(6, 2, ctx_r1.post.published), " ");
  }
}
...
function PostComponent_article_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, PostComponent_article_0_span_1_Template, 8, 0, "span", 3)(2, PostComponent_article_0_span_2_Template, 5, 1, "span", 4)(3, PostComponent_article_0_span_3_Template, 5, 0, "span", 5)(4, PostComponent_article_0_a_4_Template, 8, 6, "a", 6)(5, PostComponent_article_0_a_5_Template, 7, 4, "a", 7);
    \u0275\u0275element(6, "br")(7, "br")(8, "div", 8);
    \u0275\u0275pipe(9, "markdown");
    \u0275\u0275template(10, PostComponent_article_0_div_10_Template, 2, 0, "div", 7);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.isAuthenticated && !ctx_r1.isDeleted && !ctx_r1.isPreview);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.isDeleted && !ctx_r1.isPreview && ctx_r1.isCollapseable);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.isDeleted && !ctx_r1.isPreview);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.isPreview);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.isPreview);
    \u0275\u0275advance(3);
    \u0275\u0275property("innerHTML", \u0275\u0275pipeBind1(9, 7, ctx_r1.post.content), \u0275\u0275sanitizeHtml);
    \u0275\u0275advance(2);
...
function PostComponent_app_post_editor_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-post-editor", 15);
    \u0275\u0275twoWayListener("postChange", function PostComponent_app_post_editor_1_Template_app_post_editor_postChange_0_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.post, $event) || (ctx_r1.post = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("cancelFunction", function PostComponent_app_post_editor_1_Template_app_post_editor_cancelFunction_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleEditor());
    });
...
function HomePageComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function HomePageComponent_div_4_Template_a_click_2_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleEditor());
    });
    \u0275\u0275text(3, "Toggle Creator");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4, " ] ");
    \u0275\u0275elementEnd();
  }
...
function HomePageComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 15);
    \u0275\u0275element(1, "app-post", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const post_r3 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("post", post_r3);
  }
}
function HomePageComponent_nav_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "nav", 17)(1, "a", 18);
    \u0275\u0275listener("click", function HomePageComponent_nav_7_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.previous && ctx_r1.goToPrevious());
    });
    \u0275\u0275text(2, "Previous");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "a", 19);
    \u0275\u0275listener("click", function HomePageComponent_nav_7_Template_a_click_3_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.next && ctx_r1.goToNext());
    });
    \u0275\u0275text(4, "Next page");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275attribute("disabled", !ctx_r1.previous ? ctx_r1.previous : null);
    \u0275\u0275advance(2);
    \u0275\u0275attribute("disabled", !ctx_r1.next ? ctx_r1.next : null);
  }
}
function HomePageComponent_ng_container_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275propertyInterpolate1("routerLink", "/tags/", tag_r5.name, "");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", tag_r5.name.toUpperCase(), " ");
    \u0275\u0275advance(2);
...
function PostReaderComponent_app_post_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-post", 4);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("post", ctx_r0.post)("isReaderMode", true);
  }
}
...
function TagsPageComponent_div_1_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "a", 5)(2, "article")(3, "strong");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275propertyInterpolate1("routerLink", "/post/", post_r1._id, "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", post_r1.title, " ");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(9, 4, post_r1.published), " ");
  }
}
function TagsPageComponent_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, TagsPageComponent_div_1_ng_container_3_Template, 10, 6, "ng-container", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("\u{1F3F7}\uFE0F ", ctx_r1.postsByTag.name.toUpperCase(), "");
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.postsByTag.results);
  }
}
