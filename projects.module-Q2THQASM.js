...
_ProjectsService.\u0275fac = function ProjectsService_Factory(t) {
  return new (t || _ProjectsService)(\u0275\u0275inject(HttpClient));
};
...
var _ProjectTemplateComponent = class _ProjectTemplateComponent {
  constructor() {
    this.project = {
      _id: "",
      title: "",
...
_ProjectTemplateComponent.\u0275fac = function ProjectTemplateComponent_Factory(t) {
  return new (t || _ProjectTemplateComponent)();
};
_ProjectTemplateComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProjectTemplateComponent, selectors: [["app-project-template"]], inputs: { project: "project" }, decls: 8, vars: 6, consts: [["target", "_blank", 1, "box", 3, "href"], ["id", "title", 1, "title", "is-6"], [1, "image", "is-16by9"], ["id", "corner"], [3, "src"]], template: function ProjectTemplateComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var ProjectTemplateComponent = _ProjectTemplateComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProjectTemplateComponent, { className: "ProjectTemplateComponent", filePath: "src/app/projects/project-template/project-template.component.ts", lineNumber: 10 });
})();
...
var _ProjectsHomeComponent = class _ProjectsHomeComponent {
...
_ProjectsHomeComponent.\u0275fac = function ProjectsHomeComponent_Factory(t) {
  return new (t || _ProjectsHomeComponent)(\u0275\u0275directiveInject(ProjectsService), \u0275\u0275directiveInject(ToastyService));
};
_ProjectsHomeComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProjectsHomeComponent, selectors: [["app-projects-home"]], decls: 17, vars: 3, consts: [["class", "box", 4, "ngIf"], ["id", "filters", 1, "box"], [3, "click"], [4, "ngIf"], [1, "box"], [1, "grid", "is-col-min-10"], ["class", "cell", 4, "ngFor", "ngForOf"], [1, "cell"], [3, "project"]], template: function ProjectsHomeComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var ProjectsHomeComponent = _ProjectsHomeComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProjectsHomeComponent, { className: "ProjectsHomeComponent", filePath: "src/app/projects/projects-home/projects-home.component.ts", lineNumber: 12 });
})();
...
_ProjectsRoutingModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _ProjectsRoutingModule });
_ProjectsRoutingModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [RouterModule.forChild(routes), RouterModule] });
...
_ProjectsModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _ProjectsModule });
_ProjectsModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [
  CommonModule,
